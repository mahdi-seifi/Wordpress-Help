...
$general = array(
	...
	'general'  => array(
		...
		array(
			...
			'default'  => 'sidebar',
			'type'     => 'radio',
			'desc_tip' =>  __( 'Choose the style for the "My Account" menu-Null24.Net', 'yith-woocommerce-customize-myaccount-page' ),
			'options'  => array(
		...
		array(
			...
			'default'  => '#777777',
			'type'     => 'color',
			'desc' 	   =>  __( 'Choose the menu item color.-Nu ll 24.Net', 'yith-woocommerce-customize-myaccount-page' ),
		),
